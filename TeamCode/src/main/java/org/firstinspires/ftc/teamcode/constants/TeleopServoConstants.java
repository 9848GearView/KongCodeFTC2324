...
public class TeleopServoConstants {
    public static final double[]  LEServoPositions = {1, 0.5, 0,/*0.80*/};
    public static final double[] REServoPositions = {1, 0.5, 0.0,};
    public static final double[] WServoPositions = {1, .3, /*0.00*/};
